...
import linear_search_main as lsm #placeholder #we have options -> discuss
...
def adaptive_model(max_dist_rad, rad_search, point_list = None, max_arclength= None): 
    ...
    #maybe need to add an elif len(point_list) == 1 also
    #most likely will because of range requiremnets in cases n- (n-1)
    ...
    #recursive case
        ...
        target_maybe = lsm() #use next_search results in parameters
